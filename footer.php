            ...
            <footer class="sticky-footer bg-dark">
                <div class="container my-auto">
                    <div class="copyright text-bold p-3 text-lg text-white text-center my-auto">
                        <span>Copyright &copy; Maurice <?php echo date('Y'); ?></span><br>
                        <p> Internship Application Management System</p>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
