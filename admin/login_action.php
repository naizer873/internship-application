...
if(isset($_POST["admin_email_address"]))
{
	...
	if($total_row == 0)
	{
		$object->query = "
			...
			WHERE company_email_address = :admin_email_address
		";
		$object->execute($data);
		...
		else
		{
			...
			foreach($result as $row)
			{
				...
				{
					if($_POST["admin_password"] == $row["company_password"])
					{
						$_SESSION['admin_id'] = $row['company_id'];
						$_SESSION['type'] = 'company';
						$url = $object->base_url . 'admin/internship.php';
					}
					else
					{
